...
if page == "홈":
    ...
    with right_col:
        ...
        render_simple_list("미완료 항목", unresolved_df, "현재 미완료 항목이 없다.")
        render_simple_list("기한초과 항목", overdue_df, "현재 기한초과 항목이 없다.")
        render_simple_list("최근 완료 항목", recent_done_df, "최근 완료 항목이 없다.")
